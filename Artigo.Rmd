...
```{r, warning = FALSE, results='hide', fig.show='hold', out.width="49%"}
...
```{r cdf, fig.cap = "Função cumulativa de densidade de probabilidade com parâmetros obtidos dos dados da variável \\code{valor}"}
plotDist("lnorm", 
         meanlog = mean(log(dados$valor), na.rm = TRUE),
         sdlog = sd(log(dados$valor), na.rm = TRUE), 
         kind = "cdf")
