...
\begin{figure}
  ...
  \caption{Modelo físico demonstrando a gênese da distribuição normal. 
  FONTE: \cite{1}}
  \label{fig:normal}
\end{figure}
\vskip1ex
...
\begin{figure}
  ...
  \caption{Modelo físico demonstrando a gênese da distribuição lognormal. 
  FONTE: \cite{1}}
  \label{fig:lognormal}
\end{figure}
...
Na distribuição lognormal, diferentemente do que ocorre nas distribuições 
simétricas, como a distribuição normal, moda, média e mediana tem valores 
distintos, o que pode ser observado na figura \ref{fig:normal_lognormal}.

\vskip1ex
\begin{figure}
  \centering
  \includegraphics[width=0.99\columnwidth]
  {E:/Documents/Artigos/Dist_lognormal/images/normal_lognormal-1.png}
...
\begin{table}
  ...
  \centering
  \caption{Moda e Média em função do desvio-padrão, quando $\mu$ = 1.000.000. 
  FONTE: Autor.}
  \begin{tabular}{ccccc}
    \rowcolor{gray!50}
    \hline\hline
